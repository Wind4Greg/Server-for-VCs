# Server for Selective Disclosure Credential Processing

This relatively small development server implements a limited subset of the [Verifiable Credential API](https://w3c-ccg.github.io/vc-api/) in order to participate in interoperability test with my implementations of the `ecdsa-sd-2023` and `bbs-2023` crypto suites that support **selective disclosure** functionality. In addition, when used appropriately, the BBS based cryptosuite supports **unlinkable** derived verifiable credentials.
