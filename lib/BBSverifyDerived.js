import { API_ID_BBS_SHA, messages_to_scalars as msgsToScalars, proofVerify } from './BBS.js'
 ...
 */
export async function verifyDerived (doc, pubKey, options, gens) {
  ...
  let [bbsProof, labelMapCompressed, mandatoryIndexes, adjSelectedIndexes, ph] = decodeThing
  // Here
