...
/**
 * sign a document (credential) with ECDSA-JCS procedures.
 *
 * @param {Object} document - The unsigned credential
 * @param {Object} keyPair - The issuers private/public key pair
 * @param {Uint8Array} keyPair.priv - Byte array for the EdDSA private key without multikey prefixes
 * @param {Uint8Array} keyPair.pub - Byte array for the EdDSA public key without multikey prefixes
 ...
 */
export function eddsa_jcs_sign(document, keyPair, options) {
...
/**
 * verify a signed selective disclosure derived document (credential) with ECDSA-JCS
 ...
 *   passed on to JSON-LD processing functions. Optional.
 */
export async function eddsa_jcs_verify(signedDocument, pubKey, options) {
